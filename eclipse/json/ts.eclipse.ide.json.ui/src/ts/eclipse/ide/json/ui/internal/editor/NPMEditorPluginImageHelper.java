 ...
 *     Angelo Zerr <angelo.zerr@gmail.com> - copied from org.eclipse.wst.xml.ui.internal.tabletree.XMLEditorPluginImageHelper.java
...
import ts.eclipse.ide.json.ui.internal.TypeScriptJSONUIPlugin;
 ...
 * @author amywu
 */
public class NPMEditorPluginImageHelper {
	private static NPMEditorPluginImageHelper instance = null;
	 ...
	 */
	public synchronized static NPMEditorPluginImageHelper getInstance() {
		if (instance == null) {
			instance = new NPMEditorPluginImageHelper();
		}
		return instance;
	}
	...
	private final String PLUGINID = TypeScriptJSONUIPlugin.PLUGIN_ID;
	...
	private ImageRegistry getImageRegistry() {
		return TypeScriptJSONUIPlugin.getDefault().getImageRegistry();
	}
}
