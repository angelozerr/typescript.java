 ...
 * A context for JSDoc.
 */
public class JSDocContext extends AbstractTypeScriptContext {
	 ...
	 */
	public JSDocContext(TemplateContextType type, IDocument document, int completionOffset, int completionLength) {
