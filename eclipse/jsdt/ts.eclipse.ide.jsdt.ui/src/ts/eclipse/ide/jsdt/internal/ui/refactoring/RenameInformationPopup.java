...
//					}
	...
	public RenameInformationPopup(TypeScriptEditor editor, RenameLinkedMode renameLinkedMode) {
		fEditor= editor;
			...
			public void menuAboutToShow(IMenuManager manager) {
				...
				IAction prefsAction= new Action(JSDTTypeScriptUIMessages.RenameInformationPopup_preferences) {
					...
					public void run() {
						...
						String refactoringPrefPageID= "ts.eclipse.ide.ui.preference.TypeScriptMainPreferencePage"; //JavaBasePreferencePage.JAVA_BASE_PREF_PAGE_ID;
