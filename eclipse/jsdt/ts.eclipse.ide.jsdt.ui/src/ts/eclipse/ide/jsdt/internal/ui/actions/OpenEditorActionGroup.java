...
//	
	 ...
	 */
	public OpenEditorActionGroup(TypeScriptEditor editor) {
		fIsEditorOwner= true;
		fOpen= new OpenAction(editor);
		fOpen.setActionDefinitionId(ITypeScriptEditorActionDefinitionIds.OPEN_EDITOR);
	...
	private void setGlobalActionHandlers(IActionBars actionBars) {
		actionBars.setGlobalActionHandler(TypeScriptActionConstants.OPEN, fOpen);
	}
