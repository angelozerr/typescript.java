...
public class ReferencesSearchGroup extends ActionGroup {
	...
	// private void addWorkingSetAction(IWorkingSet[] workingSets, IMenuManager
	// manager) {
	// FindAction action;
	// if (fEditor != null)
	// action= new WorkingSetFindAction(fEditor, new
	// FindReferencesInWorkingSetAction(fEditor, workingSets),
	// SearchUtil.toString(workingSets));
	// else
	// action= new WorkingSetFindAction(fSite, new
	// FindReferencesInWorkingSetAction(fSite, workingSets),
	// SearchUtil.toString(workingSets));
	...
	private void updateGlobalActionHandlers() {
		if (fActionBars != null) {
			// fActionBars.setGlobalActionHandler(JdtActionConstants.FIND_REFERENCES_IN_WORKSPACE,
			// fFindReferencesAction);
			fActionBars.setGlobalActionHandler(TypeScriptActionConstants.FIND_REFERENCES_IN_PROJECT,
					fFindReferencesInProjectAction);
			// fActionBars.setGlobalActionHandler(JdtActionConstants.FIND_REFERENCES_IN_HIERARCHY,
			// fFindReferencesInHierarchyAction);
			// fActionBars.setGlobalActionHandler(JdtActionConstants.FIND_REFERENCES_IN_WORKING_SET,
			// fFindReferencesInWorkingSetAction);
		}
	}
