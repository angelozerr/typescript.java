...
public class BracketInserter implements VerifyKeyListener, ILinkedModeListener {
	...
	private class ExitPolicy implements IExitPolicy {
		...
		/*
		 * @see org.eclipse.wst.jsdt.internal.ui.text.link.LinkedPositionUI.
		 * ExitPolicy#doExit(org.eclipse.wst.jsdt.internal.ui.text.link.
	...
	public void verifyKey(VerifyEvent event) {
		...
		if (!event.doit || getInsertMode() != ITextEditorExtension3.SMART_INSERT)
			return;
