...
public class RenameLinkedMode {
	...
	public RenameLinkedMode(ITextSelection selection, /*IJavaElement element,*/ TypeScriptEditor editor) {
...
//			}
//
			LinkedPosition linkedPosition= new LinkedPosition(document, selection.getOffset(), selection.getLength(), 0);
			fLinkedPositionGroup.addPosition(linkedPosition);
...
//			JSDTTypeScriptUIPlugin.log(ex);
	...
	/*private RenameSupport undoAndCreateRenameSupport(String newName) throws CoreException {
		...
		try {
			...
			throw new CoreException(new Status(IStatus.ERROR, JSDTTypeScriptUIPlugin.getPluginId(), ReorgMessages.RenameLinkedMode_error_saving_editor, e));
...
//
//		IDialogSettings javaSettings= JSDTTypeScriptUIPlugin.getDefault().getDialogSettings();
