...
public class TypeScriptCompilerLaunchConstants {
	...
	public static final String PROJECT = TypeScriptCorePlugin.PLUGIN_ID + ".PROJECT"; //$NON-NLS-1$
	public static final String BUILD_PATH = TypeScriptCorePlugin.PLUGIN_ID + ".BUILD_PATH"; //$NON-NLS-1$
