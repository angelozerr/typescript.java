...
public class ValidationPreferencePage extends PropertyAndPreferencePage {
	...
	public static final String PROP_ID = "ts.eclipse.ide.ui.property.ValidationPreferencePage"; //$NON-NLS-1$
	...
	public void createControl(Composite parent) {
		...
		configurationBlock = new ValidationConfigurationBlock(getNewStatusChangedListener(), getProject(), container);
