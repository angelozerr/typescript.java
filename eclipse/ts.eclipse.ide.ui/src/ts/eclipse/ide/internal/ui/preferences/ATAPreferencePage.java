...
/**
 * Automatic Type Acquisition (ATA) preferences page
 *
 */
public class ATAPreferencePage extends PropertyAndPreferencePage {

	public static final String PREF_ID = "ts.eclipse.ide.ui.preference.ATAPreferencePage"; //$NON-NLS-1$
	public static final String PROP_ID = "ts.eclipse.ide.ui.property.ATAPreferencePage"; //$NON-NLS-1$

	private ATAConfigurationBlock configurationBlock;

	public ATAPreferencePage() {
	}

	@Override
	public void createControl(Composite parent) {
		IWorkbenchPreferenceContainer container = (IWorkbenchPreferenceContainer) getContainer();
		configurationBlock = new ATAConfigurationBlock(getNewStatusChangedListener(), getProject(), container);
