 ...
 *
 */
public class WizardNewTypeScriptProjectCreationPage extends WizardNewProjectCreationPage implements Listener, IStatusChangeListener {
	...
	protected IStatus[] validatePageImpl() {
		...
		status[0] = validateAndUpdateNodejsPath();
		return status;
	}
