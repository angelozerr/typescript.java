...
public class TypeScriptBrowserInformationControl extends BrowserInformationControl {

	public TypeScriptBrowserInformationControl(Shell parent, String symbolicFontName,
